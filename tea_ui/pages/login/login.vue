<template>
	<view class="container">
		...
		<view class="bottom">
			 <a style="text-decoration: none;" href="https://payjs.cn/api/openid?mchid=1613001888&callback_url=https://xxl.today/tea_ui">
...
export default {
	data() {
		return {
			logining: false,
			showPop: false, // 显示弹窗
			secretPassword: this.$config.env == 'dev' ? '123' : ''
		};
	},
	computed: {
