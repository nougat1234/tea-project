...
import com.app.moudles.service.UserServiceImpl;
...
public class UserController {
    ...
    public Result<User> login(String secretPassword) throws Exception {
        ...
        // 测试开发环境
        User user = userService.getUser("oK3r84teJdc7oStGn_hpRc0B2FcA"); // 微信的openid
    ...
    @NeedLogin
    @PutMapping
    public Result<Integer> updateUser(@ApiParam("更新信息表单") @RequestBody UpdateUserForm form, HttpServletRequest request) throws Exception {
